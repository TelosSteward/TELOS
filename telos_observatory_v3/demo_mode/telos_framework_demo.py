...
def get_demo_slides():
    ...
    return [
        ...
        (
            ...
            "A hospital deploys AI with a Primacy Attractor encoding patient safety and approved clinical protocols. When patients attempt to extract medication advice outside guidelines - through clever questioning, social engineering, or prompt injection - TELOS intervenes.\n\nWe tested this with 1,300 adversarial attacks across MedSafetyBench and HarmBench - standardized benchmarks for healthcare AI safety. TELOS achieved 0% Attack Success Rate across those controlled scenarios. Within the tested conditions, the system has demonstrated how it maintains its constraints without exception.\n\n[View validation results](https://zenodo.org/records/17702890)"
        ),
...
def get_demo_completion_message():
    ...
    """
    return """## Congratulations - You've Completed the TELOS Demo
...
Click the BETA button below to experience live TELOS governance. You'll see real PA calibration, dynamic fidelity scores, and actual interventions.

I'm your TELOS guide: Click the Ask Steward button at the top of your BETA session to ask me questions about what you're seeing."""
