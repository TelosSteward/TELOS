...
def main():
    ...
    *:hover {{
    ...
    if has_beta_consent:
        # HIDE SIDEBAR FOR BETA-ONLY VERSION
        st.markdown("""
        <style>
        /* Hide sidebar completely for beta-only version */
        [data-testid="stSidebar"] {
            display: none !important;
        }
        ...
        # DO NOT render sidebar for beta-only version
        # sidebar_actions.render()  # COMMENTED OUT
        ...
        # TELOS tab removed for beta-only version
    ...
    if not has_beta_consent:
        ...
        if steward_open:
            ...
            if st.session_state.active_tab == "DEMO":
                ...
                # Beta Tab with Observatory components
                conversation_display.render()
