...
class ObservatoryReview:
    ...
    def _render_turn_detail(self, turn_number: int):
        ...
        <div style="
            ...
            margin: 10px 0;
        ">
            <div style="color: #4CAF50; font-weight: bold; margin-bottom: 5px;">You:</div>
        ...
        if test_type == 'head_to_head':
            ...
            color = '#4CAF50' if shown_source == 'telos' else '#888'
            label = 'TELOS' if shown_source == 'telos' else 'Native'
