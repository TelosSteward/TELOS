-- Enhanced Telemetry with Semantic Intelligence
-- This adds contextual metadata to make data actually useful for research

-- Step 1: Add lifecycle tracking columns (fixed syntax)
...
-- Step 4: Add check constraint (drop first if exists to avoid error)
DO $$
BEGIN
...
-- Step 6: Create semantic analysis view
...
-- Step 7: Create pattern detection views

-- View: What request types cause problems?
...
-- View: Which PA components are weakest?
...
-- View: Topic-based drift patterns
...
-- View: Constraint boundary analysis
...
-- View: Incomplete turns with semantic context
