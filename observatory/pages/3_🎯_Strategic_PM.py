"""
Strategic PM View - Partnerships, grants, priorities from Steward PM.
...
<p style='text-align: center; color: #888;'>
    Partnerships, grants, and priorities from Steward PM
</p>
<hr style='border: 1px solid #FFD700;'>
""", unsafe_allow_html=True)

# Render strategic view
view = StrategicView()
view.render()
