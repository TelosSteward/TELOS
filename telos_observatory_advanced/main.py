#!/usr/bin/env python3
"""
TELOS Observatory Advanced - Main Application
Observatory version with dish icon branding.
Built from TELOS Observatory V3 with native Streamlit layout.
"""
...
from telos_observatory_advanced.core.state_manager import StateManager
from telos_observatory_advanced.utils.mock_data import generate_mock_session
from telos_observatory_advanced.components.sidebar_actions import SidebarActions
from telos_observatory_advanced.components.conversation_display import ConversationDisplay
from telos_observatory_advanced.components.observation_deck import ObservationDeck
from telos_observatory_advanced.components.teloscope_controls import TELOSCOPEControls
...
def main():
    ...
    # Page configuration
    st.set_page_config(
        page_title="TELOS Observatory Advanced",
        page_icon="🛸",
        layout="wide",
