...
class GatewayConfig(BaseModel):
    ...
    # Registry storage
    registry_storage_dir: Path = Path("./telos_gateway_registry")
    ...
    def from_env(cls) -> "GatewayConfig":
        ...
        return cls(
            host=os.environ.get("TELOS_GATEWAY_HOST", "127.0.0.1"),
            ...
            registry_storage_dir=Path(
                os.environ.get("REGISTRY_STORAGE_DIR", "./telos_gateway_registry")
            ),
        )
