...
**Expected**: All 78 tests pass in < 1 second.
...
|---------|---------|--------|-----|
| Complete Validation | 2,550 | 0% ASR | [10.5281/zenodo.18370659](https://doi.org/10.5281/zenodo.18370659) |
...
```
Raw cosine similarity < 0.35 triggers immediate block.
...
| File | Purpose |
|------|---------|
| `telos_observatory_v3/main.py` | Streamlit entry point |
| `telos_observatory_v3/services/beta_response_manager.py` | Main fidelity engine |
| `telos_observatory_v3/telos_purpose/core/constants.py` | Calibration constants |
| `telos_observatory_v3/telos_purpose/core/embedding_provider.py` | Embedding providers |
...
python3 -m streamlit run telos_observatory_v3/main.py --server.port 8501
```
...
├── validation/                    # Published validation results & scripts
