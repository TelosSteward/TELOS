## Synthetic PII Notice

The `attacker_simulated_responses.json` file is a benchmark artifact from the InjecAgent project (UIUC Kang Lab, arXiv:2403.02691). Usernames, email addresses (e.g., amy.watson@gmail.com), and file paths appearing in this data are synthetic test fixtures used as part of attack simulation scenarios, not real PII.
