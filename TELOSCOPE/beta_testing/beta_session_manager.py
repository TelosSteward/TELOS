...
@dataclass
class FeedbackData:
    """User feedback for a single response."""
    turn_number: int
    timestamp: str
    ...
    # Context
    user_message: str = ""
    response_text: str = ""  # The response shown (for single-blind)
    response_a_text: str = ""  # For head-to-head
    response_b_text: str = ""

    # Fidelity metrics (captured but not shown to user during A/B test)
