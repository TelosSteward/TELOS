...
def get_demo_slides():
    ...
    return [
        ...
        (
            ...
            "While quantum physics is fascinating, my primary purpose is to explain TELOS governance. If you'd like to understand how TELOS would handle a topic shift like quantum physics, I can explain that as an example of drift detection."
        ),
        (
