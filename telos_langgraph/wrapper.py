...
from .governance_gate import calculate_fidelity, TelosGovernanceGate
...
class TelosWrapper:
    ...
    def __init__(
        ...
        Args:
            ...
            fidelity_threshold: Threshold for intervention
    ...
    def _pre_execution_check(
        ...
        if intervention in [InterventionLevel.CONTEXT, InterventionLevel.REDIRECT]:
            result["approved"] = True
        ...
        self._record_trace(
            ...
            fidelity=fidelity,
            approved=result["approved"],
            intervention_reason=result.get("reason"),
        )
    ...
    def _inject_context(
        ...
        This is a soft intervention - adds context without blocking.
        """
        # Add PA context as system message or similar
        # Implementation depends on your message format
        context_note = {
            "role": "system",
            "content": f"[TELOS Context] User purpose: {self.pa.text}",
        }
        ...
        # Insert context at beginning
        # This implementation is simplified - adapt to your message format
    ...
    def _record_trace(
        ...
        entry = GovernanceTraceEntry(
            ...
            zone=get_zone_from_fidelity(fidelity),
            intervention_level=InterventionLevel.NONE if approved else InterventionLevel.BLOCK,
