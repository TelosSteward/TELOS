...
class BetaReview:
    ...
    def _render_beta_metrics(self, observatory_data: Dict[str, Any]):
        ...
        if regenerations:
            ...
            st.markdown(f"**When you regenerated:** Chose TELOS {telos_preferred} times, Native {native_preferred} times")
        ...
        with col1:
            ...
            st.metric("Avg Fidelity (TELOS turns)", f"{avg_fidelity_telos:.3f}")
        with col2:
