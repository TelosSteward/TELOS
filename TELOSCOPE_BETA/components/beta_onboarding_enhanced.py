...
from config.colors import GOLD, STATUS_MODERATE
    ...
    def render_drift_coaching(self):
        ...
        ">
            ...
            <div style="color: #e0e0e0; font-size: 18px; line-height: 1.8;">
                ...
                <p><strong style="color: #4CAF50;">What to Try:</strong></p>
    ...
    def render_turn_progress(self, current_turn: int):
        ...
        if current_turn >= 15:
            ...
            <div style="
                ...
                text-align: center;
            ">
                <strong style="color: #4CAF50;">✅ Beta Testing Complete!</strong><br>
                <span style="color: #e0e0e0;">Full TELOS and Observatory analysis now available</span>
            </div>
            """, unsafe_allow_html=True)
